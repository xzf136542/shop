<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\shop\public/../application/index\view\cart\index.html";i:1605224870;}*/ ?>
...
<head>
	...
	<script type="text/javascript" src="/static/index/js/cart1.js"></script>
...
<body>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr>
					...
					<td class="col4" data-goods-id="<?php echo $vo['goods_id']; ?>" data-goods-attr-ids="<?php echo $vo['goods_attr_ids']; ?>">
					...
					<td class="col6"><a href="<?php echo url('remove','goods_id=' . $vo['goods_id'] .'&goods_attr_ids='. $vo['goods_attr_ids']); ?>">删除</a></td>
				</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
			<tfoot>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="<?php echo url('pay/checkout'); ?>" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
...
<script type="text/javascript">
	...
	$('.add_num').click(function (){
		var data ={
			goods_id:$(this) .parent().attr('data-goods-id'),
			goods_attr_ids:$(this) .parent().attr('data-goods-attr-ids'),
			goods_count:parseInt($(this).prev().val())+1
		}
		changeNumber(data);
	})

	$('.reduce_num').click(function (){
		var goods_count =$(this) .next().val()-1;
		if(goods_count<=0){
			return;
		}
