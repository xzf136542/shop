<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"D:\shop\public/../application/index\view\order\index.html";i:1605073216;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="/static/index/style/home.css" type="text/css">
	<link rel="stylesheet" href="/static/index/style/order.css" type="text/css">
			...
			<div class="order_bd mt10">
				<table class="orders">
					...
					<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr>
							<td><a href=""><?php echo $vo['order_sn']; ?></a></td>
							<td><?php echo $vo['people']; ?></td>
							<td>￥<?php echo $vo['money']; if($vo['pay'] == '1'): ?>货到付款<?php else: ?>支付宝<?php endif; ?></td>
							...
							<td>
								<?php if($vo['status'] == 0): ?>
								<a href="">继续支付</a>
								<?php elseif($vo['status'] == 1): elseif($vo['status'] == 2): ?>
								<a href="">查看物流</a>
								<?php endif; ?>
