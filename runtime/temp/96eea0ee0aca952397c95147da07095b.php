<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\shop\public/../application/admin\view\attribute\index.html";i:1604500750;}*/ ?>
...
<body>
<h1>
    <span class="action-span"><a href="<?php echo url('add'); ?>">属性添加</a></span>
        ...
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <tr align="center" class="0">
                ...
                <td align="left" class="first-cell" >
                    <span><a href="javascript:void(0)"><?php echo $vo['attr_name']; ?></a></span>
                </td>
                <td align="left" class="first-cell" >
                    <span><a href="javascript:void(0)"><?php echo $vo['type_name']; ?></a></span>
                </td>
                <td align="left" class="first-cell" >
                    <span><a href="javascript:void(0)"><?php echo $vo['attr_type']; ?></a></span>
                </td>
                <td align="left" class="first-cell" >
                    <span><a href="javascript:void(0)"><?php echo $vo['attr_input_type']; ?></a></span>
                </td>
                <td align="left" class="first-cell" >
                    <span><a href="javascript:void(0)"><?php echo $vo['attr_values']; ?></a></span>
                </td>
