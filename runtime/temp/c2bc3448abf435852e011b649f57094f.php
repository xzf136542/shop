<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\shop\public/../application/index\view\goods\detail.html";i:1604806528;s:59:"D:\shop\public/../application/index\view\public\header.html";i:1605087257;s:56:"D:\shop\public/../application/index\view\public\nav.html";i:1605090050;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="/static/index/style/goods.css" type="text/css">
	<link rel="stylesheet" href="/static/index/style/common.css" type="text/css">
	...
	<script type="text/javascript" src="/static/index/js/jqzoom-core.js"></script>
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/static/index/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/static/index/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/static/index/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/static/index/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/static/index/images/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					...
					<dl class="last">
						<dt><a href=""><img src="/static/index/images/crazy4.jpg" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo $goods['goods_img']; ?>"  style="margin-top: 200px" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
								<img src="/<?php echo $goods['goods_thumb']; ?>" alt="" width="350" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($goods['imgs']) || $goods['imgs'] instanceof \think\Collection || $goods['imgs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['imgs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<li <?php if($i == '1'): ?>class="cur"<?php endif; ?>>
									<a <?php if($i == '1'): ?>class="zoomThumbActive"<?php endif; ?>  href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/<?php echo $vo['goods_img']; ?>',largeimage: '/<?php echo $vo['goods_img']; ?>'}">
										<img src="/<?php echo $vo['goods_thumb']; ?>"></a>
								</li>
`								<?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo date('Y-m-d',$goods['add_time']); ?></li>
					...
					<form action="<?php echo url('Cart/addCart'); ?>" method="post" class="choose">
						...
						<ul>
							<?php if(is_array($goods['single']) || $goods['single'] instanceof \think\Collection || $goods['single'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['single'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<li class="product">
								<dl>
									...
									<dd>
										...
										<a <?php if($i == '1'): ?> class="selected"<?php endif; ?> href="javascript:;"><?php echo $v['attr_value']; ?> <input type="radio" name="goods_attr_ids[<?php echo $v['attr_id']; ?>]" value="<?php echo $v['id']; ?>" checked="checked" /></a>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($goods['unique']) || $goods['unique'] instanceof \think\Collection || $goods['unique'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['unique'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<li><span><?php echo $vo['attr_name']; ?>：<?php echo $vo['attr_value']; ?></span></li>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</div>
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/static/index/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/static/index/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="/static/index/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
